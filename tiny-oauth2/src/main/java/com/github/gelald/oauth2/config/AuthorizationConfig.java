...
/**
 * 认证配置
 * {@link EnableMethodSecurity} 开启全局方法认证
 * 启用JSR250注解支持，例如{@code @RolesAllowed}, {@code @PermitAll}, {@code @DenyAll}注解
 * 启用{@code Secured}注解支持
 * <p>
...
public class AuthorizationConfig {
    ...
    public RegisteredClientRepository registeredClientRepository(JdbcTemplate jdbcTemplate, PasswordEncoder passwordEncoder) {
        ...
        RegisteredClient registeredClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri("http://127.0.0.1:19502/login/oauth2/code/messaging-client-oidc")
        ...
        RegisteredClient pkceClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                // 生成 code verifier 和 code challenge：https://tonyxu-io.github.io/pkce-generator/
